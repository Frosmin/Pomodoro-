...
const tareas = () => {
    ...
    const handleAddTask = () => {
      if(newTask.name.trim() !== ""){
        ...
        addTask({name: newTask.name, estimated_effort: 1, list_id: getMainListID()});
  ...
  return (
    <View style={taskList_styles.container}>
      ...
      <View>
        <TextInput placeholder="Nueva Tarea" value={newTask.name} onChangeText={(text) => setNewTask({...newTask, name: text})}/>
